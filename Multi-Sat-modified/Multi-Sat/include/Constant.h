...
const double imp_max = 2.0 / sqrt(3);

// 第一个vector是脉冲星的编号，第二个vector是脉冲的次数
const std::vector<int> imp_sat = { 5, 6, 7 };
const std::vector<int> imp_num = { 1, 1, 2 };
...
const double sats_coe0[TreeNum][6] = { {7220.860449638,		0.001175,				0.96779041093837,	2.6731317786684,	1.19204226874,			5.4442725563892},
									   ...
									   {7191.918677895 ,	0.018242 ,				0.454286245755619 , 3.6444391750772 ,	3.4658053107439 ,		0.724806848396011 },
									   {7196.9423159455,	0.00053973005219847,	0.46534794371164,	5.2068884196977,	-0.30667212860269,		1.0529503679091},
